...
int testing_zgebrd(int argc, char **argv)
{
    ...
    double *E2               = (double *)            malloc(minMN*sizeof(double));
    ...
    PLASMA_Alloc_Workspace_zgebrd(M, N, &T);
    ...
    */
    ...
    /* PLASMA ZGEBRD */
    INFO = PLASMA_zgebrd(jobu, jobvt, M, N, A1, LDA, S2, E2, T, U, M, VT, N);
    if(INFO!=0){
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA ZGEBRD ROUTINE -------  \n");
    ...
    INFO = LAPACKE_zbdsqr(LAPACK_COL_MAJOR, lapack_const(uplo),
                            minMN, NCVT, NRU, NCC,
                            S2, E2,
                            VT, N, U, M, NULL, 1 );
    ...
    if ( (info_solution == 0) & (info_orthou == 0) & 
        ...
        if (M >= N) {
           printf("***************************************************\n");
           printf(" ---- TESTING ZGEBRD .. M >= N ........... PASSED !\n");
           printf("***************************************************\n");
        }
        else {
           printf("***************************************************\n");
        ...
        if (M >= N) {
           printf("************************************************\n");
           printf(" - TESTING ZGEBRD .. M >= N .. FAILED !\n");
           printf("************************************************\n");
        }
        else {
           printf("************************************************\n");
