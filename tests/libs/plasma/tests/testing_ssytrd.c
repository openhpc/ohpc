...
int testing_ssytrd(int argc, char **argv)
{
    ...
    float             *E2   = (float *)malloc(N*sizeof(float));
    ...
    */
     ...
     * PLASMA SSYTRD 
     */
    INFO = PLASMA_ssytrd(vec, uplo, N, A2, LDA, W2, E2, T, Q, LDQ);
    if(INFO!=0){
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA SSYTRD ROUTINE -------  \n");
    ...
    INFO = LAPACKE_ssteqr(
                    LAPACK_COL_MAJOR, lapack_const(vec),
                    N, W2, E2, Q, LDQ );
    if(INFO!=0){
            printf(" ERROR OCCURED LAPACKE_ssteqr INFO %d\n",INFO);
            goto fin;
    }
    ...
    if ( (info_solution == 0) & (info_ortho == 0) & (info_reduction == 0) ) {
        printf("***************************************************\n");
        printf(" ---- TESTING SSYTRD ...................... PASSED !\n");
        printf("***************************************************\n");
    }
    else {
        printf("************************************************\n");
        printf(" - TESTING SSYTRD ... FAILED !\n");
        printf("************************************************\n");
    }
