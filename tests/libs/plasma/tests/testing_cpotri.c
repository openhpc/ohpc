    ...
    */
    for(u=0; u<2; u++) {
        ...
        if ( (info_inverse == 0) && (info_factorization == 0) ) {
            printf("***************************************************\n");
            printf(" ---- TESTING CPOTRI(%s)................. PASSED !\n", uplostr[u]);
            printf("***************************************************\n");
        }
        else {
            printf("***************************************************\n");
            printf(" - TESTING CPOTRI(%s) ... FAILED !\n", uplostr[u]);
            printf("***************************************************\n");
        }
    }
...
static int check_inverse(int N, PLASMA_Complex32_t *A1, PLASMA_Complex32_t *A2, int LDA, int uplo, float eps )
{
    int info_inverse;
    int i, j;
