...
int testing_cgesv_incpiv(int argc, char **argv)
{
    ...
    */
    ...
    /* PLASMA CGESV */
    PLASMA_Alloc_Workspace_cgesv_incpiv(N, &L, &IPIV);
    PLASMA_cgesv_incpiv(N, NRHS, A2, LDA, L, IPIV, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR PLASMA INCPIV CGESV ROUTINE -------  \n");
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV CGESV ............... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("************************************************\n");
        printf(" - TESTING INCPIV CGESV ... FAILED !\n");
        printf("************************************************\n");
    }
    ...
    */
    ...
    /* Plasma routines */
    PLASMA_cgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    PLASMA_cgetrs_incpiv(PlasmaNoTrans, N, NRHS, A2, LDA, L, IPIV, B2, LDB);
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV CGETRF + CGETRS ..... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("***************************************************\n");
        printf(" - TESTING INCPIV CGETRF + CGETRS ... FAILED !\n");
        printf("***************************************************\n");
    }
    ...
    */
    ...
    /* PLASMA routines */
    PLASMA_cgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    PLASMA_ctrsmpl(N, NRHS, A2, LDA, L, IPIV, B2, LDB);
    PLASMA_ctrsm(PlasmaLeft, PlasmaUpper, PlasmaNoTrans, PlasmaNonUnit,
                 N, NRHS, 1.0, A2, LDA, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR PLASMA INCPIV CGETRF + CTRSMPL + CTRSM  ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV CGETRF + CTRSMPL + CTRSM ... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("**************************************************\n");
        printf(" - TESTING INCPIV CGETRF + CTRSMPL + CTRSM ... FAILED !\n");
        printf("**************************************************\n");
    }
