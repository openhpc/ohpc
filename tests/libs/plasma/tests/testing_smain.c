...
int main (int argc, char **argv)
{
     ...
     */
      ...
      info = testing_ssyr2k( argc, argv );
        ...
        info = testing_spemv( argc, argv );
    } else if ( strcmp(func, "GEADD") == 0 ) {
        info = testing_sgeadd( argc, argv );
    /*
     * Linear system
     */
        ...
        info = testing_sgesv_incpiv( argc, argv );
