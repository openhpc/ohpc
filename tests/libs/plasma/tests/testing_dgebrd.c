...
int testing_dgebrd(int argc, char **argv)
{
    ...
    PLASMA_Alloc_Workspace_dgebrd(M, N, &T);
    ...
    */
    ...
    /* PLASMA DGEBRD */
    INFO = PLASMA_dgebrd(jobu, jobvt, M, N, A1, LDA, S2, E2, T, U, M, VT, N);
    if(INFO!=0){
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA DGEBRD ROUTINE -------  \n");
    ...
    INFO = LAPACKE_dbdsqr(LAPACK_COL_MAJOR, lapack_const(uplo),
                            minMN, NCVT, NRU, NCC,
                            S2, E2,
                            VT, N, U, M, NULL, 1 );
    ...
    if ( (info_solution == 0) & (info_orthou == 0) & 
        ...
        if (M >= N) {
           printf("***************************************************\n");
           printf(" ---- TESTING DGEBRD .. M >= N ........... PASSED !\n");
           printf("***************************************************\n");
        }
        else {
           printf("***************************************************\n");
        ...
        if (M >= N) {
           printf("************************************************\n");
           printf(" - TESTING DGEBRD .. M >= N .. FAILED !\n");
           printf("************************************************\n");
        }
        else {
           printf("************************************************\n");
