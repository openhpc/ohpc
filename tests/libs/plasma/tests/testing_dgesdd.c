...
int testing_dgesdd(int argc, char **argv)
{
    ...
    PLASMA_Alloc_Workspace_dgesdd(M, N, &T);
    ...
    */
    ...
    /* PLASMA DGESDD */
    INFO = PLASMA_dgesdd(jobu, jobvt, M, N, A1, LDA, S2, T, U, M, VT, N);
    if(INFO!=0){
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA DGESDD ROUTINE -------  \n");
    ...
    if ( (info_solution == 0) & (info_orthou == 0) & 
        ...
        if (M >= N) {
           printf("***************************************************\n");
           printf(" ---- TESTING DGESDD .. M >= N ........... PASSED !\n");
           printf("***************************************************\n");
        }
        else {
           printf("***************************************************\n");
        ...
        if (M >= N) {
           printf("************************************************\n");
           printf(" - TESTING DGESDD .. M >= N .. FAILED !\n");
           printf("************************************************\n");
        }
        else {
           printf("************************************************\n");
