...
int testing_chetrd(int argc, char **argv)
{
    ...
    PLASMA_Alloc_Workspace_chetrd(N, N, &T);
    ...
    */
     ...
     * PLASMA CHETRD 
     */
    INFO = PLASMA_chetrd(vec, uplo, N, A2, LDA, W2, E2, T, Q, LDQ);
    if(INFO!=0){
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA CHETRD ROUTINE -------  \n");
    ...
    INFO = LAPACKE_csteqr(
                    ...
                    N, W2, E2, Q, LDQ );
    if(INFO!=0){
            printf(" ERROR OCCURED LAPACKE_csteqr INFO %d\n",INFO);
            goto fin;
    }
    ...
    if ( (info_solution == 0) & (info_ortho == 0) & (info_reduction == 0) ) {
        printf("***************************************************\n");
        printf(" ---- TESTING CHETRD ...................... PASSED !\n");
        printf("***************************************************\n");
    }
    else {
        printf("************************************************\n");
        printf(" - TESTING CHETRD ... FAILED !\n");
        printf("************************************************\n");
    }
