...
int testing_dgesv_incpiv(int argc, char **argv)
{
    ...
    */
    ...
    /* PLASMA DGESV */
    PLASMA_Alloc_Workspace_dgesv_incpiv(N, &L, &IPIV);
    PLASMA_dgesv_incpiv(N, NRHS, A2, LDA, L, IPIV, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR PLASMA INCPIV DGESV ROUTINE -------  \n");
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV DGESV ............... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("************************************************\n");
        printf(" - TESTING INCPIV DGESV ... FAILED !\n");
        printf("************************************************\n");
    }
    ...
    */
    ...
    /* Plasma routines */
    PLASMA_dgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    PLASMA_dgetrs_incpiv(PlasmaNoTrans, N, NRHS, A2, LDA, L, IPIV, B2, LDB);
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV DGETRF + DGETRS ..... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("***************************************************\n");
        printf(" - TESTING INCPIV DGETRF + DGETRS ... FAILED !\n");
        printf("***************************************************\n");
    }
    ...
    */
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA INCPIV DGETRF + DTRSMPL + DTRSM  ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV DGETRF + DTRSMPL + DTRSM ... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("**************************************************\n");
        printf(" - TESTING INCPIV DGETRF + DTRSMPL + DTRSM ... FAILED !\n");
        printf("**************************************************\n");
    }
