...
int testing_zhetrd(int argc, char **argv)
{
    ...
    PLASMA_Alloc_Workspace_zhetrd(N, N, &T);
    ...
    */
     ...
     * PLASMA ZHETRD 
     */
    INFO = PLASMA_zhetrd(vec, uplo, N, A2, LDA, W2, E2, T, Q, LDQ);
    if(INFO!=0){
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA ZHETRD ROUTINE -------  \n");
    ...
    INFO = LAPACKE_zsteqr(
                    ...
                    N, W2, E2, Q, LDQ );
    if(INFO!=0){
            printf(" ERROR OCCURED LAPACKE_zsteqr INFO %d\n",INFO);
            goto fin;
    }
    ...
    if ( (info_solution == 0) & (info_ortho == 0) & (info_reduction == 0) ) {
        printf("***************************************************\n");
        printf(" ---- TESTING ZHETRD ...................... PASSED !\n");
        printf("***************************************************\n");
    }
    else {
        printf("************************************************\n");
        printf(" - TESTING ZHETRD ... FAILED !\n");
        printf("************************************************\n");
    }
