...
*                      also changed in cchkaa.f and ctest.in
      PARAMETER          ( NTYPES = 3 )
      INTEGER            NTESTS
      PARAMETER          ( NTESTS = 3 )
      REAL               ONE, ZERO
...
*     .. External Subroutines ..
      EXTERNAL           ALAHD, ALASUM, CLACPY, CLASET, CLATMS,
     $                   PLASMA_CGEQP3, ICOPY, SLAORD, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*     $                  'cgeqp3 m=', m, '  n=', n, '  lda=', lda,
*     $                  '  nb=', nb, '  imode=', imode
*
                  SRNAMT = 'CGEQP3'
                  CALL PLASMA_CGEQP3( M, N, A, LDA, IWORK( N+1 ),
     $                                TAU, WORK, RWORK, INFO )
*
