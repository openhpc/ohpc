...
*                      also changed in dchkaa.f and dtest.in
      PARAMETER          ( NTYPES = 3 )
      INTEGER            NTESTS
      PARAMETER          ( NTESTS = 3 )
...
*     .. External Subroutines ..
      EXTERNAL           ALAHD, ALASUM, DLACPY, DLAORD, DLASET,
     $                   PLASMA_DGEQP3, DLATMS, ICOPY, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*     $                  'dgeqp3 m=', m, '  n=', n, '  lda=', lda,
*     $                  '  nb=', nb, '  imode=', imode
*
                  SRNAMT = 'DGEQP3'
                  CALL PLASMA_DGEQP3( M, N, A, LDA, IWORK( N+1 ),
     $                                TAU, WORK,
     $                                WORK((N+1)*NB), INFO )
*
