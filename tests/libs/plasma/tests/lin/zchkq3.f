...
*                      also changed in zchkaa.f and ztest.in
      PARAMETER          ( NTYPES = 3 )
      INTEGER            NTESTS
      PARAMETER          ( NTESTS = 3 )
...
*     .. External Subroutines ..
      EXTERNAL           ALAHD, ALASUM, DLAORD, ICOPY, XLAENV,
     $                   PLASMA_ZGEQP3, ZLACPY, ZLASET, ZLATMS
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*     $                  'zgeqp3 m=', m, '  n=', n, '  lda=', lda,
*     $                  '  nb=', nb, '  imode=', imode
*
                  SRNAMT = 'ZGEQP3'
                  CALL PLASMA_ZGEQP3( M, N, A, LDA, IWORK( N+1 ),
     $                                TAU, WORK, RWORK, INFO )
*
