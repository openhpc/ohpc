...
*        SGELS
*
         CALL PLASMA_ALLOC_WORKSPACE_SGELS( 2, 2, HT, INFO )
*
         SRNAMT = 'SGELS '
         INFOT = 103
         CALL PLASMA_SGELS( '/', 0, 0, 0, A, 1, HT, B, 1, INFO )
         CALL CHKXER( 'SGELS ', INFOT, NOUT, INFO, OK )
         INFOT = 2
         CALL PLASMA_SGELS( PLASMANOTRANS, -1, 0, 0, A, 1, HT,
     $                     B, 1, INFO )
         CALL CHKXER( 'SGELS ', INFOT, NOUT, INFO, OK )
         INFOT = 3
         CALL PLASMA_SGELS( PLASMANOTRANS, 0, -1, 0, A, 1, HT,
     $                     B, 1, INFO )
         CALL CHKXER( 'SGELS ', INFOT, NOUT, INFO, OK )
         INFOT = 4
         CALL PLASMA_SGELS( PLASMANOTRANS, 0, 0, -1, A, 1, HT,
     $                     B, 1, INFO )
         CALL CHKXER( 'SGELS ', INFOT, NOUT, INFO, OK )
         INFOT = 6
         CALL PLASMA_SGELS( PLASMANOTRANS, 2, 0, 0, A, 1, HT,
     $                     B, 2, INFO )
         CALL CHKXER( 'SGELS ', INFOT, NOUT, INFO, OK )
         INFOT = 9
         CALL PLASMA_SGELS( PLASMANOTRANS, 2, 0, 0, A, 2, HT,
     $                     B, 1, INFO )
         CALL CHKXER( 'SGELS ', INFOT, NOUT, INFO, OK )
*
