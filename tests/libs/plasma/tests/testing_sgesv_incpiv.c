...
int testing_sgesv_incpiv(int argc, char **argv)
{
    ...
    */
    ...
    /* PLASMA SGESV */
    PLASMA_Alloc_Workspace_sgesv_incpiv(N, &L, &IPIV);
    PLASMA_sgesv_incpiv(N, NRHS, A2, LDA, L, IPIV, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR PLASMA INCPIV SGESV ROUTINE -------  \n");
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV SGESV ............... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("************************************************\n");
        printf(" - TESTING INCPIV SGESV ... FAILED !\n");
        printf("************************************************\n");
    }
    ...
    */
    ...
    /* Plasma routines */
    PLASMA_sgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    PLASMA_sgetrs_incpiv(PlasmaNoTrans, N, NRHS, A2, LDA, L, IPIV, B2, LDB);
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV SGETRF + SGETRS ..... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("***************************************************\n");
        printf(" - TESTING INCPIV SGETRF + SGETRS ... FAILED !\n");
        printf("***************************************************\n");
    }
    ...
    */
    ...
    /* PLASMA routines */
    PLASMA_sgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    PLASMA_strsmpl(N, NRHS, A2, LDA, L, IPIV, B2, LDB);
    PLASMA_strsm(PlasmaLeft, PlasmaUpper, PlasmaNoTrans, PlasmaNonUnit,
                 N, NRHS, 1.0, A2, LDA, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR PLASMA INCPIV SGETRF + STRSMPL + STRSM  ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
    ...
    if ((info_solution == 0)){
        printf("***************************************************\n");
        printf(" ---- TESTING INCPIV SGETRF + STRSMPL + STRSM ... PASSED !\n");
        printf("***************************************************\n");
    }
    else{
        printf("**************************************************\n");
        printf(" - TESTING INCPIV SGETRF + STRSMPL + STRSM ... FAILED !\n");
        printf("**************************************************\n");
    }
