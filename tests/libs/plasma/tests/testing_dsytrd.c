...
int testing_dsytrd(int argc, char **argv)
{
    ...
    PLASMA_Alloc_Workspace_dsytrd(N, N, &T);
    ...
    */
     ...
     * PLASMA DSYTRD 
     */
    INFO = PLASMA_dsytrd(vec, uplo, N, A2, LDA, W2, E2, T, Q, LDQ);
    if(INFO!=0){
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA DSYTRD ROUTINE -------  \n");
    ...
    INFO = LAPACKE_dsteqr(
                    ...
                    N, W2, E2, Q, LDQ );
    if(INFO!=0){
            printf(" ERROR OCCURED LAPACKE_dsteqr INFO %d\n",INFO);
            goto fin;
    }
    ...
    if ( (info_solution == 0) & (info_ortho == 0) & (info_reduction == 0) ) {
        printf("***************************************************\n");
        printf(" ---- TESTING DSYTRD ...................... PASSED !\n");
        printf("***************************************************\n");
    }
    else {
        printf("************************************************\n");
        printf(" - TESTING DSYTRD ... FAILED !\n");
        printf("************************************************\n");
    }
