...
void c_fortran_dgssv_(int *iopt, int *n, int *nnz, int *nrhs, double *values,
 ...
 */
	...
	if (*iopt == 1) { /* LU decomposition */
		...
		dCreate_CompCol_Matrix(&A, *n, *n, *nnz, values, rowind0,
				       colptr0, SLU_NC, SLU_D, SLU_GE);
	 ...
	 */
		...
		dgstrf(&options, &AC, relax, panel_size, etree, NULL, 0, perm_c,
		...
		*f_factors = (fptr)LUfactors;
		...
		dCreate_Dense_Matrix(&B, *n, *nrhs, b, *ldb, SLU_DN, SLU_D,
				     SLU_GE);
