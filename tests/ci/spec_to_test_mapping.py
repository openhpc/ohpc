...
test_map = {
    ...
    "components/io-libs/hdf5/SPECS/hdf5.spec": ["hdf5 phdf5", "", "zlib-devel"],
    ...
    "components/io-libs/phdf5/SPECS/hdf5.spec": ["phdf5", "", ""],
    ...
    "components/parallel-libs/boost/SPECS/boost.spec": ["boost", "", ""],
