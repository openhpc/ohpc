...
\multirow{10}{*}{3.8.3} &
\multirow{10}{\linewidth}{Extrae tool. \newline {\color{logoblue} \url{https://tools.bsc.es}}}\\
...
& \\
\cline{1-2} imb-gnu15-mpich-ohpc &\multirow{2}{*}{2021.10}
& \\
...
& \\
\cline{1-2} omb-gnu14-mpich-ohpc &\multirow{4}{*}{7.5}
& \\
...
pdtoolkit-arm1-ohpc &
\multirow{5}{*}{3.25.1} &
\multirow{5}{\linewidth}{PDT is a framework for analyzing source code. \newline {\color{logoblue} \url{http://www.cs.uoregon.edu/Research/pdt}}}\\
...
\multirow{6}{*}{2.5} &
\multirow{10}{\linewidth}{Toolset for performance analysis of large-scale parallel applications. \newline {\color{logoblue} \url{http://www.scalasca.org}}}\\
...
& \\
\cline{1-2} scalasca-gnu14-mpich-ohpc &\multirow{4}{*}{2.6.2}
& \\
...
\multirow{6}{*}{7.1} &
\multirow{10}{\linewidth}{Scalable Performance Measurement Infrastructure for Parallel Codes. \newline {\color{logoblue} \url{http://www.vi-hps.org/projects/score-p}}}\\
...
& \\
\cline{1-2} scorep-gnu14-mpich-ohpc &\multirow{3}{*}{9.0}
& \\
scorep-gnu14-openmpi5-ohpc &
& \\
\cline{1-2} scorep-gnu15-mpich-ohpc &\multirow{2}{*}{9.3}
& \\
...
& \\
\cline{1-2} tau-gnu15-mpich-ohpc &\multirow{2}{*}{2.34.1}
& \\
