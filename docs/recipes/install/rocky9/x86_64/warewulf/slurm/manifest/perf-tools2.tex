...
\multirow{9}{*}{2.5} &
\multirow{21}{\linewidth}{Toolset for performance analysis of large-scale parallel applications. \newline {\color{logoblue} \url{http://www.scalasca.org}}}\\
...
& \\
\cline{1-2} scalasca-gnu14-impi-ohpc &\multirow{12}{*}{2.6.2}
& \\
...
\multirow{9}{*}{7.1} &
\multirow{21}{\linewidth}{Scalable Performance Measurement Infrastructure for Parallel Codes. \newline {\color{logoblue} \url{http://www.vi-hps.org/projects/score-p}}}\\
...
& \\
\cline{1-2} scorep-gnu14-impi-ohpc &\multirow{5}{*}{9.0}
& \\
...
& \\
\cline{1-2} scorep-gnu15-impi-ohpc &\multirow{8}{*}{9.3}
& \\
...
& \\
\cline{1-2} tau-gnu15-impi-ohpc &\multirow{8}{*}{2.34.1}
& \\
