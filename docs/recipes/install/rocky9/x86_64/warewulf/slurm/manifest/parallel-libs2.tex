...
\multirow{20}{*}{3.18.1} &
\multirow{20}{\linewidth}{Portable Extensible Toolkit for Scientific Computation. \newline {\color{logoblue} \url{http://www.mcs.anl.gov/petsc}}}\\
...
\multirow{9}{*}{7.0.1} &
\multirow{20}{\linewidth}{Graph, mesh and hypergraph partitioning library using MPI. \newline {\color{logoblue} \url{http://www.labri.fr/perso/pelegrin/scotch}}}\\
...
& \\
\cline{1-2} ptscotch-gnu14-impi-ohpc &\multirow{11}{*}{7.0.7}
& \\
...
\multirow{9}{*}{2.2.0} &
\multirow{20}{\linewidth}{A subset of LAPACK routines redesigned for heterogeneous computing. \newline {\color{logoblue} \url{https://netlib.org/scalapack}}}\\
...
& \\
\cline{1-2} scalapack-gnu14-impi-ohpc &\multirow{11}{*}{2.2.2}
& \\
...
\multirow{20}{*}{6.4.0} &
\multirow{20}{\linewidth}{A general purpose library for the direct solution of linear equations. \newline {\color{logoblue} \url{https://portal.nersc.gov/project/sparse/superlu}}}\\
