...
[sms](*\#*) ip addr add ${sms_ip}/${internal_netmask} dev ${sms_eth_internal}
[sms](*\#*) ip link set ${sms_eth_internal} up
...
[sms](*\#*) perl -pi -e "s/\$clienthost \S+/\$clienthost ${sms_hostname}/" $CHROOT/var/spool/pbs/mom_priv/config
...
% Not compatible with PBS Professional.
