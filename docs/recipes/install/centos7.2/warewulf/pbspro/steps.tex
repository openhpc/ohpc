...
\noindent{\Large\color{logodarkgrey}\fontfamily{phv}\selectfont{\provisioner{}/\rms{} Edition for Linux*}} \\
...
[sms](*\#*) (*\chrootinstall*) pbspro-execution-ohopc
[sms](*\#*) perl -pi -e "s/PBS_SERVER=\S+/PBS_SERVER=${sms_hostname}/" $CHROOT/etc/pbs.conf
[sms](*\#*) chroot $CHROOT opt/ohpc/pub/pbs/etc/pbs_habitat
[sms](*\#*) echo "\$usecp *:/home /home" >> $CHROOT/var/spool/pbs/mom_priv/config
[sms](*\#*) echo "PBS_SCP=/usr/bin/scp" >> $CHROOT/etc/pbs.conf
