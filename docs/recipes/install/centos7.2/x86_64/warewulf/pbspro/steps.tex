...
on a {\em master} node, or on the IB switch itself. The optimal placement of the subnet
manager is beyond the scope of this document, but \baseOS{} provides the
