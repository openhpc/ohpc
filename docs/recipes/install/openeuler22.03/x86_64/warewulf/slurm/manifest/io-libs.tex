...
\multirow{9}{*}{1.14.0} &
\multirow{9}{\linewidth}{A general purpose library and file format for storing scientific data. \newline {\color{logoblue} \url{http://www.hdfgroup.org/HDF5}}}\\
...
\multirow{9}{*}{1.7.7} &
\multirow{9}{\linewidth}{Scalable I/O Library for Parallel Access to Task-Local Files. \newline {\color{logoblue} \url{https://apps.fz-juelich.de/jsc/sionlib/docu/index.html}}}\\
