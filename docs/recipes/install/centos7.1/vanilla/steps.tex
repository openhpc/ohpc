...
%[master]$ fsp_repo=http://fsp.cmt.intel.com/ForestPeak/VER/CentOS-7.1_Intel/ForestPeak:VER.repo 
...
# Restart/enable relevant services to support provisioning and ntp
...
\path{/opt/fsp/admin/images/centos7.1}. Note that \Warewulf{} assumes access to
