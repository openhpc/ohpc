...
\lhead{{2015 \FSP{} Install Guide - {\small \em CentOS7.1 Version}}}
...
\begin{lstlisting}[language=bash]
[master]$ yum -y install gnu-compilers-fsp intel-compilers-devel-fsp
\end{lstlisting}
% end_fsp_run
...
[master]$ yum -y groupinstall fsp-trilinos # adds 6 Trilinos packages
[master]$ yum -y install R_base-fsp        # adds R_base 
\end{lstlisting}
% end_fsp_run
