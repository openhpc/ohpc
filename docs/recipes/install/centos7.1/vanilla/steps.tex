...
%% [FSP-469] [master](*\#*) systemctl start postgresql
%% [FSP-469] 
...
[master](*\#*) echo "GATEWAYDEV=${eth_provision}" > /tmp/network.$$
[master](*\#*) wwsh -y file import /tmp/network.$$ --name network
[master](*\#*) wwsh -y set network --path /etc/sysconfig/network --mode=0644 --uid=0
