...
% begin_ohpc_run
% ohpc_comment_header Add InfiniBand support services on {\em master} node \ref{sec:add_ofed}
\begin{lstlisting}[language=bash,keywords={}]
...
% begin_ohpc_run
% ohpc_comment_header Complete basic Warewulf setup for {\em master} node \ref{sec:setup_ww}
%\begin{verbatim}
