...
\lhead{{\OHPC{} Install Guide - {\small \em \baseOS{} Version} (v\OHPCVersion{}) } }
{\hspace*{4in} \includegraphics[width=1.8in]{intel_1spot_100.pdf}}

\vspace*{2cm}
\noindent {\LARGE \color{RoyalBlue} \fontfamily{phv}\selectfont OpenHPC (v\OHPCVersion{})} \vspace*{0.1cm} \\
...
[master]$ ohpc_repo=http://tcgsw-obs.pdx.intel.com:82/OpenHPC:/VER/CentOS-7.1_Intel/OpenHPC:VER.repo
...
% begin_fsp_run
% fsp_comment_header Enable OpenHPC repository for local use \ref{sec:enable_repo}
\begin{lstlisting}[language=bash,keywords={}]
[master]$ wget -P /etc/yum.repos.d ${ohpc_repo}
\end{lstlisting}
% end_fsp_run

% master]$ export OpenHPC_mirror=http://tcgsw-obs.pdx.intel.com:82/ForestPeak:
% master]$ wget -P /etc/yum.repos.d
% ${rsp_repo}/15.31:/Factory/CentOS-7.1_Intel/ForestPeak:15.31:Factory.repo
...
% begin_fsp_run
% fsp_comment_header Add OpenHPC components to compute image \ref{sec:add_components}
\begin{lstlisting}[language=bash,literate={-}{-}1,keywords={},upquote=true]
...
% begin_fsp_run
% fsp_validation_comment Add OpenHPC components to compute instance
\begin{lstlisting}[language=bash,literate={-}{-}1,keywords={},upquote=true]
...
% begin_fsp_run
% fsp_validation_newline
% fsp_command if [ ${enable_nagios} -eq 1 ];then
% fsp_indent 5
% fsp_validation_comment Install Nagios on master and vnfs image
\begin{lstlisting}[language=bash,keywords={},upquote=true]
...
% begin_fsp_run
% fsp_validation_newline
% fsp_command if [ ${enable_ganglia} -eq 1 ];then
% fsp_indent 5
% fsp_validation_comment Install Ganglia on master
\begin{lstlisting}[language=bash,keywords={},upquote=true]
# Install Ganglia
...
%% [FSP-469] [master]$ postgresql-setup initdb
%% [FSP-469] 
