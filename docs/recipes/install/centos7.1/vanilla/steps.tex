...
[master]$ wget -P /etc/yum.repos.d ${rsp_repo}/15.31:/Factory/CentOS-7.1_Intel/ForestPeak:15.31:Factory.repo
\end{lstlisting}
% end_fsp_run
...
[master]$ for ((i=0; i<$num_computes; i++)) ; do \
              wwsh -y node set ${c_name[$i]} -D ib0 --ipaddr=${c_ipib[$i]} --netmask=${ipoib_netmask}
           done
