...
\lhead{{2015 \FSP{} Install Guide - {\small \em \baseOS{} Version}
    (v\FSPVersion{}) } }
%\fancyfoot[RE,RO]{\small Last Update: \VCDateISO~(Rev: \VCRevision) - v\FSPVersion{}}

\newcommand{\install}{yum -y install}
\newcommand{\chrootinstall}{yum -y --installroot=\$CHROOT install}
\newcommand{\chrootgroupinstall}{yum -y --installroot=\$CHROOT groupinstall}
...
[master]$ export FSP_mirror=http://tcgsw-obs.pdx.intel.com:82/ForestPeak:
[master]$ wget -P /etc/yum.repos.d ${FSP_mirror}/15.31:/Factory/CentOS-7.1_Intel/ForestPeak:15.31:Factory.repo
\end{lstlisting}
% end_fsp_run
...
% fsp_ci_comment - Remove WW file update crontab entry
% [master]$ rm -f /etc/cron.d/wwupdatefiles
% end_fsp_run

% begin_fsp_run
% fsp_validation_newline
% fsp_ci_comment Format space for /opt/fsp
...
% begin_fsp_run 
% fsp_validation_newline
% fsp_ci_comment - allow sudo without tty
% [master]$ perl -pi -e "s/^Defaults\s+requiretty/# Defaults requiretty/" /etc/sudoers 
% fsp_validation_newline
% end_fsp_run
...
[master]$ (*\chrootgroupinstall*) fsp-nagios
...
% begin_fsp_run 
% fsp_validation_newline
% fsp_ci_comment Add optional kargs to bootstrap kernel
% [master]$ wwsh provision set c[1-4] --kargs=acpi_pad.disable=1
% fsp_validation_newline
% end_fsp_run
