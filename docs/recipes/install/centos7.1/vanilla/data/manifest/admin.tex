...
% <-- begin entry for ganglia-fsp
\multirow{2}{*}{ganglia-fsp} & 
\multirow{2}{*}{3.7.1} & 
...
% <-- begin entry for nagios-fsp
\multirow{2}{*}{nagios-fsp} & 
\multirow{2}{*}{3.5.1} & 
Nagios monitors hosts and services and yells if somethings breaks.  { \color{blue} http://www.nagios.org} 
\\ \hline 
% <-- end entry for %name_base

% <-- begin entry for nagios-plugins-fsp
\multirow{2}{*}{nagios-plugins-fsp} & 
\multirow{2}{*}{2.0.1} & 
