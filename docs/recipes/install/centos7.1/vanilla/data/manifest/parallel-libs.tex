...
\multirow{2}{*}{mkl-blacs} & 
\multirow{2}{*}{11.3} & 
Intel(R) Math Kernel Library Basic Linear Algebra Communication Subprograms.  { \color{blue} http://software.intel.com/en-us/intel-mkl} 
\\ \hline 
...
% <-- begin entry for parmetis
parmetis-gnu-impi-fsp & 
\multirow{6}{*}{4.0.3} & 
\multirow{6}{\linewidth}{Serial Graph Partitioning and Fill-reducing Matrix Ordering. \newline {\color{blue} http://glaros.dtc.umn.edu/gkhome/metis/metis/overview}} \\ 
