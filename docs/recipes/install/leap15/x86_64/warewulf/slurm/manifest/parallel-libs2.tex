...
& \\
\cline{1-2} mumps-gnu15-impi-ohpc &\multirow{8}{*}{5.8.1}
& \\
...
\multirow{13}{*}{3.18.1} &
\multirow{21}{\linewidth}{Portable Extensible Toolkit for Scientific Computation. \newline {\color{logoblue} \url{http://www.mcs.anl.gov/petsc}}}\\
...
& \\
\cline{1-2} petsc-gnu15-impi-ohpc &\multirow{8}{*}{3.23.5}
& \\
...
\multirow{9}{*}{7.0.1} &
\multirow{21}{\linewidth}{Graph, mesh and hypergraph partitioning library using MPI. \newline {\color{logoblue} \url{http://www.labri.fr/perso/pelegrin/scotch}}}\\
...
& \\
\cline{1-2} ptscotch-gnu14-impi-ohpc &\multirow{12}{*}{7.0.7}
& \\
...
\multirow{9}{*}{2.2.0} &
\multirow{21}{\linewidth}{A subset of LAPACK routines redesigned for heterogeneous computing. \newline {\color{logoblue} \url{https://netlib.org/scalapack}}}\\
...
& \\
\cline{1-2} scalapack-gnu14-impi-ohpc &\multirow{12}{*}{2.2.2}
& \\
...
\multirow{13}{*}{3.18.0} &
\multirow{21}{\linewidth}{A library for solving large scale sparse eigenvalue problems. \newline {\color{logoblue} \url{http://slepc.upv.es}}}\\
...
& \\
\cline{1-2} slepc-gnu15-impi-ohpc &\multirow{8}{*}{3.23.0}
& \\
...
\multirow{21}{*}{6.4.0} &
\multirow{21}{\linewidth}{A general purpose library for the direct solution of linear equations. \newline {\color{logoblue} \url{https://portal.nersc.gov/project/sparse/superlu}}}\\
