...
\multirow{9}{*}{1.81.0} &
\multirow{21}{\linewidth}{Free peer-reviewed portable C++ source libraries. \newline {\color{logoblue} \url{http://www.boost.org}}}\\
...
& \\
\cline{1-2} boost-gnu14-impi-ohpc &\multirow{12}{*}{1.88.0}
& \\
...
\multirow{21}{*}{3.3.10} &
\multirow{21}{\linewidth}{A Fast Fourier Transform library. \newline {\color{logoblue} \url{http://www.fftw.org}}}\\
...
\multirow{9}{*}{2.18.1} &
\multirow{21}{\linewidth}{Scalable algorithms for solving linear systems of equations. \newline {\color{logoblue} \url{http://www.llnl.gov/casc/hypre}}}\\
...
& \\
\cline{1-2} hypre-gnu14-impi-ohpc &\multirow{12}{*}{2.33.0}
& \\
...
\multirow{21}{*}{4.4} &
\multirow{21}{\linewidth}{Lightweight, general, scalable C++ library for finite element methods. \newline {\color{logoblue} \url{http://mfem.org}}}\\
...
\multirow{13}{*}{5.2.1} &
\multirow{21}{\linewidth}{A MUltifrontal Massively Parallel Sparse direct Solver. \newline {\color{logoblue} \url{http://graal.ens-lyon.fr/MUMPS}}}\\
