...
\multirow{21}{*}{2.0} &
\multirow{21}{\linewidth}{OpenHPC default login environments. \newline {\color{logoblue} \url{https://github.com/openhpc/ohpc}}}\\
...
& \\
lmod-defaults-gnu13-impi-ohpc &
& \\
lmod-defaults-gnu13-mvapich2-ohpc &
& \\
lmod-defaults-gnu13-openmpi5-ohpc &
& \\
lmod-defaults-gnu14-impi-ohpc &
& \\
...
% <-- begin entry for lmod-apparmor-abstractions-ohpc
\multirow{2}{*}{lmod-apparmor-abstractions-ohpc} &
\multirow{2}{*}{8.7.64} &
Apparmor bash Abstraction for Lmod. \newline { \color{logoblue} \url{https://github.com/TACC/Lmod}}
\\ \hline
% <-- end entry for lmod-apparmor-abstractions-ohpc
