...
[master]$ wget -P /etc/yum.repos.d $FSP_mirror/ForestPeak:/15.16:/Factory/CentOS-7.1_Intel/ForestPeak:15.16:Factory.repo
\end{lstlisting}
% end_fsp_run
...
# Set master host as data aggregator
[master]$ perl -pi -e "s/aggregator_hostname/<master_ip>/" /etc/open-rcm/etc/orcm-site.xml
