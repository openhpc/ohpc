...
\begin{lstlisting}[language=bash,keywords={}]
[master]$ yum -y install libibverbs-runtime libmlx4-rdmav2
[master]$ yum -y install libibmad5 librdmacm1 rdma
...
# Configure DHCP server to use eno2
[master]$ perl -pi -e 's/^DHCPD_INTERFACE=""/DHCPD_INTERFACE="eno2"/' /etc/sysconfig/dhcpd
...
# Add IB support
[master]$ yum -y --installroot=$CHROOT install libibverbs-runtime libmlx4-rdmav2
[master]$ yum -y --installroot=$CHROOT install libibmad5 librdmacm1 rdma
