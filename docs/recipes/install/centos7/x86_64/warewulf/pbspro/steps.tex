...
\begin{center}
  \begin{tcolorbox}[]
    \small Note that \Warewulf{} is configured by default to access an external
    repository (vault.centos.org) during the \texttt{wwmkchroot} process.  If
...
[sms](*\#*) export CHROOT=/opt/ohpc/admin/images/centos7.3
...
\input{common/customization_appendix}
\input{manifest}
