...
\multirow{4}{*}{3.0} & 
\multirow{14}{\linewidth}{Scalable Performance Measurement Infrastructure for Parallel Codes. \newline {\color{logoblue} \url{http://www.vi-hps.org/projects/score-p}}} \\ 
...
& \\ 
\cline{1-2} scorep-gnu7-impi-ohpc &\multirow{10}{*}{3.1}
& \\ 
...
& \\ 
\cline{1-2} tau-gnu7-impi-ohpc &\multirow{8}{*}{2.27}
& \\ 
tau-gnu7-mpich-ohpc &
& \\ 
