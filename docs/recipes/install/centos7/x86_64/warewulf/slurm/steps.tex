...
% ohpc_comment_header Optionally add InfiniBand to compute node image \ref{sec:add_components}
...
% ohpc_comment_header Optionally add Omni-Path support to compute node image \ref{sec:add_components}
