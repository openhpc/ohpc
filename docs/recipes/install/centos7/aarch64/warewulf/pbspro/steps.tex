...
\newcommand{\baseOS}{CentOS7.6}
\newcommand{\OSRepo}{CentOS\_7.6}
...
\begin{itemize*}
\item CentOS-7 - Base 7.6.1810
  (e.g. \href{http://mirror.centos.org/altarch/7.6.1810/os/aarch64/}
  {\color{blue}{http://mirror.centos.org/altarch/7.6.1810/os/aarch64/}} )
  \item EPEL 7
