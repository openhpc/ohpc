...
& \\ 
\cline{1-2} imb-gnu7-mpich-ohpc &\multirow{2}{*}{2018.1}
& \\ 
...
\cline{1-2} pdtoolkit-gnu7-ohpc &\multirow{1}{*}{3.25}
& \\ 
\hline
...
& \\ 
\cline{1-2} scorep-gnu7-mpich-ohpc &\multirow{3}{*}{3.1}
& \\ 
...
\multirow{2}{*}{1.7.0} & 
\multirow{2}{\linewidth}{Scalable Performance Measurement Infrastructure for Parallel Codes.  {\color{logoblue} \url{http://www.fz-juelich.de/ias/jsc/EN/Expertise/Support/Software/SIONlib/_node.html}}} \\ 
...
& \\ 
\cline{1-2} tau-gnu7-mpich-ohpc &\multirow{2}{*}{2.27}
& \\ 
