...
\begin{itemize*}
\item CentOS-7 - Base 7.4.1708
  (e.g. \href{http://mirror.centos.org/altarch/7.4.1708/os/aarch64/}
  {\color{blue}{http://mirror.centos.org/altarch/7.4.1708/os/aarch64/}} )
  \item EPEL 7
