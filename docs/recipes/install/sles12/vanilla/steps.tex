...
[master]$ zypper addrepo $FSP_mirror/ForestPeak:/15.27:/Factory/SLE_12_Intel/ForestPeak:15.27:Factory.repo
...
[master]$ zypper -n install -t pattern fsp-trilinos # adds 6 Trilinos packages
[master]$ zypper -n install R_base-fsp              # adds R
\end{lstlisting}
% end_fsp_run
