...
\begin{lstlisting}[language=bash]
[master]$ zypper -n install fsp-scipy               # adds 1 scientific python package
[master]$ zypper -n install fsp-numpy               # adds 1 numerical python package
...
[master]$ zypper -n install -t pattern fsp-phdf5    # adds 6 PETSC packages
