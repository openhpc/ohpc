...
With the \InfiniBand{} drivers included, you can also enable IPoIB funcionality
...
\subsection{Add Intel\textsuperscript{\textregistered} Cluster Checker ({\em optional})} \label{sec:add_clck}
