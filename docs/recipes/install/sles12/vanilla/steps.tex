...
%[master](*\#*) zypper addrepo $OpenHPC_mirror/ForestPeak:/15.16/SLE_12_Intel/ForestPeak:15.16.repo
...
[master](*\#*) systemctl restart mysql
[master](*\#*) systemctl enable apache2.service
[master](*\#*) systemctl restart apache2
\end{lstlisting}
%\end{verbatim}
% end_ohpc_run
...
[master](*\#*) exportfs -a
[master](*\#*) systemctl restart nfsserver
...
%% [FSP-469] [master](*\#*) systemctl restart postgresql
%% [FSP-469] 
