...
be included in the compute image as follows:

% begin_fsp_run
% fsp_validation_comment Install ORCM client
\begin{lstlisting}[language=bash]
[master]$ zypper --root=$CHROOT -n install -t pattern fsp-orcm-client
# Set master host as data aggregator
[master]$ perl -pi -e "s/aggregator_hostname/<master_ip>/" /etc/orcm-site.xml
\end{lstlisting}
% end_fsp_run
