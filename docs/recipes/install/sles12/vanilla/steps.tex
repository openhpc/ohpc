...
\lhead{ \small {\color{logodarkgrey}\fontfamily{phv}\selectfont { Install
      Guide} - {\baseOS{} Version} (v\OHPCVersion{}) } \vspace*{0pt} }

{\hspace*{4in} \includegraphics[width=1.8in]{ohpc_logo_blue.pdf}}
...
default location for this example is in \path{/opt/ohpc/admin/images/sles12}.
...
[sms](*\#*) perl -pi -e "s/ControlMachine=\S+/ControlMachine=${master_ip}/" $CHROOT/etc/slurm/slurm.conf
