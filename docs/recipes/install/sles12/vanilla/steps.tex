...
% [master]$    wwsh -y provision set c[9-16] --vnfs=sles12 --bootstrap=`uname -r` --files=dynamic_hosts,passwd,group,shadow,munge.key 
% [master]$    wwsh -y provision set c[9-16] --fileadd=ifcfg-ib0.ww     
% [master]$    service dhcpd restart
% [master]$    wwsh pxe update
% [master]$ fi
% end_fsp_run
