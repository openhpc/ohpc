...
\item
  \href{http://download.opensuse.org/repositories/server:/monitoring/SLE_12_SP2/}
       {\color{blue}{Server Monitoring Software}} (*only required for nagios/ganglia)
\item
  \href{http://download.opensuse.org/repositories/devel:/languages:/python/SLE_12_SP2/}
...
\input{common/synclist_osimage_stateless}
