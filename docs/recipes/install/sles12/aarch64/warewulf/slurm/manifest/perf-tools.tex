...
mpiP-gnu-mpich-ohpc &
\multirow{4}{*}{3.4.1} & 
\multirow{4}{\linewidth}{mpiP: a lightweight profiling library for MPI applications. \newline {\color{logoblue} \url{http://mpip.sourceforge.net}}} \\ 
...
\multirow{4}{*}{2.3.1} & 
\multirow{4}{\linewidth}{Toolset for performance analysis of large-scale parallel applications. \newline {\color{logoblue} \url{http://www.scalasca.org}}} \\ 
...
& \\ 
\cline{1-2} scorep-gnu7-mpich-ohpc &\multirow{2}{*}{3.1}
& \\ 
