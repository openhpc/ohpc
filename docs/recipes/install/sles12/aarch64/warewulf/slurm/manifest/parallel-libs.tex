...
& \\ 
\cline{1-2} boost-gnu8-mpich-ohpc &\multirow{2}{*}{1.71.0}
& \\ 
...
& \\ 
\cline{1-2} hypre-gnu8-mpich-ohpc &\multirow{2}{*}{2.18.1}
& \\ 
...
& \\ 
\cline{1-2} mfem-gnu8-mpich-ohpc &\multirow{2}{*}{4.0}
& \\ 
...
& \\ 
\cline{1-2} mumps-gnu8-mpich-ohpc &\multirow{2}{*}{5.2.1}
& \\ 
...
& \\ 
\cline{1-2} petsc-gnu8-mpich-ohpc &\multirow{2}{*}{3.12.0}
& \\ 
...
\multirow{2}{*}{2.0.2} & 
\multirow{2}{\linewidth}{A subset of LAPACK routines redesigned for heterogeneous computing.  {\color{logoblue} \url{http://www.netlib.org/lapack-dev}}} \\ 
