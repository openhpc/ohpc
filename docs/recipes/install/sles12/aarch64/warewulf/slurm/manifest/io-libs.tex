...
\multirow{2}{*}{1.11.0} & 
\multirow{5}{\linewidth}{The Adaptable IO System (ADIOS). \newline {\color{logoblue} \url{http://www.olcf.ornl.gov/center-projects/adios}}} \\ 
adios-gnu-openmpi-ohpc &
& \\ 
\cline{1-2} adios-gnu7-openmpi-ohpc &\multirow{1}{*}{1.12.0}
& \\ 
\cline{1-2} adios-gnu7-mpich-ohpc &\multirow{2}{*}{1.13.0}
& \\ 
...
& \\ 
\cline{1-2} netcdf-fortran-gnu-mpich-ohpc &\multirow{6}{*}{4.4.4}
& \\ 
...
& \\ 
\cline{1-2} netcdf-gnu7-mpich-ohpc &\multirow{2}{*}{4.5.0}
& \\ 
...
& \\ 
\cline{1-2} phdf5-gnu7-mpich-ohpc &\multirow{3}{*}{1.10.1}
& \\ 
