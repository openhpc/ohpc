...
\multirow{9}{*}{1.81.0} &
\multirow{20}{\linewidth}{Free peer-reviewed portable C++ source libraries. \newline {\color{logoblue} \url{http://www.boost.org}}}\\
...
& \\
\cline{1-2} boost-gnu14-impi-ohpc &\multirow{11}{*}{1.88.0}
& \\
...
\multirow{9}{*}{2.18.1} &
\multirow{20}{\linewidth}{Scalable algorithms for solving linear systems of equations. \newline {\color{logoblue} \url{http://www.llnl.gov/casc/hypre}}}\\
...
& \\
\cline{1-2} hypre-gnu14-impi-ohpc &\multirow{11}{*}{2.33.0}
& \\
...
\multirow{20}{*}{4.4} &
\multirow{20}{\linewidth}{Lightweight, general, scalable C++ library for finite element methods. \newline {\color{logoblue} \url{http://mfem.org}}}\\
