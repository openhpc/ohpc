...
\multirow{2}{*}{15.1.0} &
The GNU C Compiler and Support Files.  { \color{logoblue} \url{http://gcc.gnu.org}}
\\ \hline
...
\multirow{2}{*}{2025.0} &
Intel(R) oneAPI HPC Toolkit Repository Setup.  { \color{logoblue} \url{https://github.com/openhpc/ohpc}}
\\ \hline
