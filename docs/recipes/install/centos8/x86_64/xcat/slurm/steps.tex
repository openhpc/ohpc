...
\newcommand{\baseOS}{CentOS8.3}
\newcommand{\OSRepo}{CentOS\_8.3}
...
\newcommand{\beegfsrepo}{https://www.beegfs.io/release/beegfs\_7.2/dists/beegfs-rhel8.repo}
...
distributions. To enable additional respoitories for local use, issue the following:
