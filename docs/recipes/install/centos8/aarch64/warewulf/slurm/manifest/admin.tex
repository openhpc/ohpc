...
% <-- begin entry for lmod-defaults-arm1-mpich-ohpc
\multirow{2}{*}{lmod-defaults-arm1-mpich-ohpc} & 
\multirow{2}{*}{2.0} & 
OpenHPC default login environments. \newline { \color{logoblue} \url{https://github.com/openhpc/ohpc}} 
\\ \hline 
% <-- end entry for lmod-defaults-arm1-mpich-ohpc

% <-- begin entry for lmod-defaults-arm1-openmpi4-ohpc
\multirow{2}{*}{lmod-defaults-arm1-openmpi4-ohpc} & 
\multirow{2}{*}{2.0} & 
OpenHPC default login environments. \newline { \color{logoblue} \url{https://github.com/openhpc/ohpc}} 
\\ \hline 
% <-- end entry for lmod-defaults-arm1-openmpi4-ohpc

% <-- begin entry for lmod-defaults-gnu9-mpich-ofi-ohpc
\multirow{2}{*}{lmod-defaults-gnu9-mpich-ofi-ohpc} & 
\multirow{2}{*}{2.0} & 
OpenHPC default login environments. \newline { \color{logoblue} \url{https://github.com/openhpc/ohpc}} 
\\ \hline 
% <-- end entry for lmod-defaults-gnu9-mpich-ofi-ohpc

% <-- begin entry for lmod-defaults-gnu9-mpich-ucx-ohpc
\multirow{2}{*}{lmod-defaults-gnu9-mpich-ucx-ohpc} & 
\multirow{2}{*}{2.0} & 
OpenHPC default login environments. \newline { \color{logoblue} \url{https://github.com/openhpc/ohpc}} 
\\ \hline 
% <-- end entry for lmod-defaults-gnu9-mpich-ucx-ohpc

% <-- begin entry for lmod-defaults-gnu9-openmpi4-ohpc
\multirow{2}{*}{lmod-defaults-gnu9-openmpi4-ohpc} & 
\multirow{2}{*}{2.0} & 
OpenHPC default login environments. \newline { \color{logoblue} \url{https://github.com/openhpc/ohpc}} 
\\ \hline 
% <-- end entry for lmod-defaults-gnu9-openmpi4-ohpc
