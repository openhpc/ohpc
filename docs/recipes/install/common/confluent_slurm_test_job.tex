...
[sms](*\#*) echo "/etc/passwd -> /etc/passwd" >> /var/lib/confluent/public/os/(*\confluentprofile*)/syncfiles
[sms](*\#*) echo "/etc/group -> /etc/group"   >> /var/lib/confluent/public/os/(*\confluentprofile*)/syncfiles
