...
[sms](*\#*) echo "/etc/passwd -> /etc/passwd" > /var/lib/confluent/public/os/(*\confluentprofile*)
[sms](*\#*) echo "/etc/group -> /etc/group" >> /var/lib/confluent/public/os/(*\confluentprofile*)
[sms](*\#*) echo "/etc/shadow -> /etc/shadow" >> /var/lib/confluent/public/os/(*\confluentprofile*)
\end{lstlisting}
% \end_ohpc_run
