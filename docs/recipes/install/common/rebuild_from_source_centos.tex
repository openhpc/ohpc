...
[test@sms ~]$ sudo yum-builddep fftw-gnu9-openmpi5-ohpc

# Download SRPM from OpenHPC repository and install locally
[test@sms ~]$ yumdownloader --source fftw-gnu9-openmpi5-ohpc
[test@sms ~]$ rpm -i ./fftw-gnu9-openmpi5-ohpc-3.3.8-5.1.ohpc.2.0.src.rpm
...
[test@sms ~rpmbuild/SPECS]$ sudo (*\install*) \
        ../RPMS/ARCH/fftw-gnu9-openmpi5-static-ohpc.2.0-3.3.8-6.1.ARCH.rpm
