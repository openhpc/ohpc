...
[sms](*\#*) (*\install*) ohpc-perf-tools-intel
[sms](*\#*) (*\install*) ohpc-python-libs-intel
[sms](*\#*) (*\install*) ohpc-runtimes-intel
[sms](*\#*) (*\install*) ohpc-parallel-libs-intel-mpich
[sms](*\#*) (*\install*) ohpc-parallel-libs-intel-mvapich2
[sms](*\#*) (*\install*) ohpc-parallel-libs-intel-openmpi
[sms](*\#*) (*\install*) ohpc-parallel-libs-intel-impi
\end{lstlisting}
% ohpc_indent 0
% ohpc_command fi
% end_ohpc_run
