...
\section{Package Manifest} \label {appendix:manifest}
...
\begin{table}[h!]
\caption{\bf Available \OHPC{} Meta-packages}
\label{table:groups}
...
%% % meta-packages (2)
%% \begin{table}[h!]
%% \caption*{Table~\ref{table:groups} (cont): {\bf Available \OHPC{} Meta-packages} }
