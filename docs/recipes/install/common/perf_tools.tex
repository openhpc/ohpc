...
%%% \begin{tcolorbox}[]
%%% \small
%%% \OHPC{} provides several \IntelR{} performance tools as a convenience, but a valid license
%%% is necessary to enable for use locally. Please refer to \ref{sec:byol} for more details.
%%% \end{tcolorbox}
%%% \end{center}
