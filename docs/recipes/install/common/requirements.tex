...
guide require additional licenses outside of the scope of OpenHPC. These 
licenses are provided free of charge for many catagories of use. In particular,
...
\begin{figure}[hbt]
\center
\includegraphics[width=0.8\linewidth]{ohpc-arch-small.pdf}
\vspace*{-0.2cm}
