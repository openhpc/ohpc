...
{\color{purple}{EPOL update}} repository on openEuler-24.03, you can run the following
command:

% begin_ohpc_run
% ohpc_indent 5
\begin{lstlisting}[language=bash,keywords={},basicstyle=\fontencoding{T1}\fontsize{7.6}{10}\ttfamily]
[sms](*\#*) (*\addrepo*) https://eur.openeuler.openatom.cn/coprs/openhpc/OpenHPC/repo/openeuler-24.03_LTS_SP2/openhpc-OpenHPC-openeuler-24.03_LTS_SP2.repo
