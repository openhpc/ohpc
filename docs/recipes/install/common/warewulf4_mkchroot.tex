...
\begin{lstlisting}[language=bash,literate={-}{-}1,keywords={},upquote=true,keepspaces,literate={BOSVER}{\baseos{}}1 {OSIMAGE}{\osimage{}}1 {ARCH}{\arch{}}1 {TAG}{\OSTag{}}1 {OSTREE}{\OSTree{}}1]
...
%%  dnf -y install http://repos.openhpc.community/OpenHPC/4/OSTREE/ARCH/ohpc-release-4-1.TAG.ARCH.rpm
  ...
  dnf config-manager --add-repo http://obs.openhpc.community:82/OpenHPC4:/4.0:/Factory/OSTREE/
  rpm --import http://obs.openhpc.community:82/OpenHPC4:/4.0:/Factory/OSTREE/repodata/repomd.xml.key
%% end FIXME
  dnf -y update
EOF
\end{lstlisting}
