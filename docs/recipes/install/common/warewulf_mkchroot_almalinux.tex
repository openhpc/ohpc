...
\begin{center}
  \begin{tcolorbox}[]
    ...
    repository (repo.almalinux.org) during the \texttt{wwmkchroot} process.  If
    the master host cannot reach the public AlmaLinux mirrors, or if you prefer to
...
[sms](*\#*) wwmkchroot -v almalinux-9 $CHROOT
