...
[sms](*\#*) dnf install http://repos.openhpc.community/OpenHPC/VER/OSTREE/ARCH/ohpc-release-VER-1.TAG.ARCH.rpm
\end{lstlisting}
\else
% non-CentOS
\begin{lstlisting}[language=bash,keywords={},basicstyle=\fontencoding{T1}\fontsize{7.8}{10}\ttfamily,
	literate={VER}{\OHPCVerTree{}}1 {OSTREE}{\OSTree{}}1 {TAG}{\OSTag{}}1 {ARCH}{\arch{}}1 {-}{-}1]
[sms](*\#*) rpm -ivh http://repos.openhpc.community/OpenHPC/VER/OSTREE/ARCH/ohpc-release-VER-1.TAG.ARCH.rpm
\end{lstlisting}
\fi
