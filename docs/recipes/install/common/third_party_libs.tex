...
permutations when applicable). Please refer to Appendix~\ref{appendix:manifest}
for a more detailed listing of all available packages in each of these functional
areas. To install available package offerings within \OHPC{}, issue the following:
