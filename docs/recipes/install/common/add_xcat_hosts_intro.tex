...
related to \xCAT{}, has also robust discovery capabilities and can be used to
...
% begin_ohpc_run
% ohpc_validation_newline
% ohpc_validation_comment Enable execution of postbootscript
\begin{lstlisting}[language=bash,keywords={},upquote=true,basicstyle=\footnotesize\ttfamily,]
...
With the desired compute nodes and domain identified, the next step in the
