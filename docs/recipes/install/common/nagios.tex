...
are provided by the underlying distro and the following commands can
...
as desired on on login nodes, service nodes, or compute hosts.
...
# Install nrpe and two additional plugins into compute node image
...
# (edit as desired to add all desired compute hosts)
...
# Update perms on ping command to allow nagios user to execute
