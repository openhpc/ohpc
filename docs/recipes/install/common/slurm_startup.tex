...
% fsp_command    perl -pi -e "s/^PartitionName=normal Nodes=(\S+)/PartitionName=noarmal Nodes=c[1-${num_computes}]/" /etc/slurm/slurm.conf
% fsp_command    service slurmctld restart
