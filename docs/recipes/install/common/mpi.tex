...
\begin{tabular}{@{\hspace*{0.2cm}} *5l @{}}    \toprule
             & Ethernet (TCP)         & Infiniband             & OmniPath               \\ \midrule
\rowcolor{black!10} MPICH        & \multicolumn{1}{c}{\Checkmark}  &                        &                        \\
MVAPICH2     &                        & \multicolumn{1}{c}{\Checkmark}  &                        \\
\rowcolor{black!10} MVAPICH2-psm &                        &                        & \multicolumn{1}{c}{\Checkmark}  \\
OpenMPI      & \multicolumn{1}{c}{\Checkmark}  & \multicolumn{1}{c}{\Checkmark}  &                        \\
\rowcolor{black!10} OpenMPI-psm  &                        &                        & \multicolumn{1}{c}{\Checkmark}  \\ \bottomrule
\end{tabular}
\end{table}
