\section{Finalizing provisioning configuration} \label{sec:assemble_bootstrap}
...
\subsection{Two-Stage Provisioning (optional)}
...
[sms](*\#*) wwctl image exec --build=false BOSVER -- /usr/bin/dnf install -y warewulf-ohpc-dracut \
  ignition gdisk
...
\subsection{Build image image and overlays}
...
\subsection{Register nodes for provisioning}
