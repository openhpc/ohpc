...
\newcommand{\baseOS}{openEuler 24.03 SP2}
\newcommand{\OSRepo}{openEuler\_24.03}
\newcommand{\OSTree}{openEuler\_24.03}
\newcommand{\OSTag}{oe2403}
\newcommand{\baseos}{openeuler24.03}
\newcommand{\baseosshort}{openeuler24.03}
\newcommand{\osimage}{openeuler:24.03}
...
\newcommand{\beegfsrepo}{https://www.beegfs.io/release/beegfs\_8.1/dists/beegfs-rhel10.repo}
...
\input{common/install_provisioning_warewulf4_intro_openeuler}
...
\input{common/warewulf4_add_to_compute_chroot_intro_openeuler}
...
%\subsubsection{Add \beegfs{}} \label{sec:add_beegfs}
