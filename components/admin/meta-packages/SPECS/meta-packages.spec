...
Requires:  adios-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  hdf5-gnu%{gnu_major_ver}%{PROJ_DELIM}
Requires:  netcdf-cxx-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  netcdf-cxx-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  netcdf-fortran-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  netcdf-fortran-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  netcdf-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  netcdf-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  pnetcdf-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  pnetcdf-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  phdf5-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  phdf5-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
%ifnarch aarch64
...
Requires:  boost-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  fftw-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  fftw-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  hypre-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  hypre-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  mumps-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  mumps-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  petsc-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  petsc-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  scalapack-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  scalapack-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  slepc-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  slepc-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  ptscotch-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  ptscotch-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  superlu_dist-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  superlu_dist-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  trilinos-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  trilinos-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
%ifnarch aarch64
...
%package -n %{PROJ_NAME}-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}-parallel-libs
...
Requires:  superlu_dist-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  trilinos-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
%description -n %{PROJ_NAME}-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}-parallel-libs
...
Requires:  imb-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  mpiP-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  mpiP-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  papi%{PROJ_DELIM}
Requires:  tau-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  tau-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  scalasca-gnu%{gnu_major_ver}-mpich%{PROJ_DELIM}
Requires:  scalasca-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
%ifnarch aarch64
...
Requires:  python-scipy-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}%{PROJ_DELIM}
%ifnarch aarch64
...
Requires:  adios-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
Requires:  netcdf-cxx-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
Requires:  netcdf-fortran-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
Requires:  netcdf-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
Requires:  pnetcdf-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
Requires:  phdf5-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
%package -n %{PROJ_NAME}-intel-openmpi%{openmpi_major_version}-parallel-libs
Summary:   OpenHPC parallel libraries for Intel(R) Parallel Studio XE and OpenMPI
Requires:  boost-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  hypre-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  mumps-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  petsc-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  scalapack-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  slepc-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  ptscotch-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  superlu_dist-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
Requires:  trilinos-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
%description -n %{PROJ_NAME}-intel-openmpi%{openmpi_major_version}-parallel-libs
...
Requires:  imb-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
Requires:  tau-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
Requires:  scalasca-intel-openmpi%{openmpi_major_version}%{PROJ_DELIM}
...
%files -n %{PROJ_NAME}-gnu%{gnu_major_ver}-openmpi%{openmpi_major_version}-parallel-libs
...
%files -n %{PROJ_NAME}-intel-openmpi%{openmpi_major_version}-parallel-libs
