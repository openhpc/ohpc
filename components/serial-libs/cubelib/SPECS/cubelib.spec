...
Summary:        CUBE Uniform Behavioral Encoding generic presentation library component
...
Source0:        https://perftools.pages.jsc.fz-juelich.de/cicd/cubelib/tags/cubelib-%{version}/cubelib-%{version}.tar.gz
