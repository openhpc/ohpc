...
if ! eval "$INSTALL_CMD -c $SINGULARITY_ROOTFS/$ZYPP_CONF --root $SINGULARITY_ROOTFS --gpg-auto-import-keys -n install --auto-agree-with-licenses sles-release bash coreutils $INSTALLPKGS"; then
