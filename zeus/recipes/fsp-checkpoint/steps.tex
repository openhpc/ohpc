...
%%%initializing the config mgmt system with an FSP-tuned template that includes
%%%the following FSP package groups:
%%%\begin{itemize*}
%%%\item FSP-base
%%%\item FSP-warewulf
%%%\item FSP-slurm-server
%%%\item Infiniband Support
%%%\end{itemize*}
