...
The install procedure outlined in Section~\ref{sec:basic_install}
...
development environment including C/C++/Fortran compilers, MPI stacks,
and a variety of 3rd party libraries.
