...
%%% To facilitate running test jobs later on under the resource manager, we also
%%% add a "test" user as follows:
%%% 
%%% % begin_fsp_run
%%% % fsp_validation_comment Add test user
%%% \begin{lstlisting}[language=bash,keywords={}]
%%% [master]$ useradd test                                  # add "slurm" user
%%% \end{lstlisting}
%%% % end_fsp_run
%%% 
...
the end-site adminstrator will procure and install the necessary licenses in
...
NFS file system that was propogated to the {\em compute} nodes in this recipe
