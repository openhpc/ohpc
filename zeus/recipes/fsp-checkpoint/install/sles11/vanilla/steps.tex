...
able to run jobs. Recall that we added a "test" user on the {\em master} host
in \S\ref{sec:add_rm} and the following commands use this account to compile a
simple "hello-world" MPI application and execute it interactively through the
resource manager.
