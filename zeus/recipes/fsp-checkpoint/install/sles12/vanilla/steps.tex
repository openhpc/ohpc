...
[master]$ zypper addrepo http://fsp-obs.pdx.intel.com:82/fsp/SLE_12_GMC_Intel/fsp.repo
[master]$ zypper addrepo \
    http://fsp-obs.pdx.intel.com:82/ForestPeak:/Factory/SLE_12_Intel/ForestPeak:Factory.repo
...
# Configure Warewulf to use MariaDB as the datastore
[master]$ perl -pi -e "s/driver\s+= mysql/driver     = mariadb/" /etc/warewulf/database.conf
